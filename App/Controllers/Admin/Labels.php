...
//                    'continue' => __('Continue', 'wp-loyalty-rules'),
	...
	function localData() {
		...
		$earning_status    = ( isset( $setting_option['wlr_earning_status'] ) && ! empty( $setting_option['wlr_earning_status'] ) ? $setting_option['wlr_earning_status'] : array(
			'processing',
			'completed'
		) );
		...
		$localize = array(
			...
			'point_users'              => array(
				...
				'href_link'                 => admin_url( 'admin.php?' . http_build_query( array(
			...
			'earn_campaign'            => array(
				...
				'add_new_campaign'        => admin_url( 'admin.php?' . http_build_query( array(
						'page' => WLR_PLUGIN_SLUG,
			...
			'rewards'                  => array(
				...
				'add_new_reward_url' => admin_url( 'admin.php?' . http_build_query( array(
						'page' => WLR_PLUGIN_SLUG,
						'view' => 'add_new_reward'
					) ) ),
			),
